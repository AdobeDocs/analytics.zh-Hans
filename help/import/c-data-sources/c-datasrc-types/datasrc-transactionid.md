...
请参阅 [集成脱机数据](../../../import/c-data-sources/datasrc-integrating-offline-data.md#concept_B5C576220F1548B5A3A57112AA3960C6)。
...
| 购物车查看 | 购物车查看次数。 |
| 结账 | 结账次数。 |
| EventN | eventN发生次数。N的有效值为整数-1000。如果您指定一个查看事件，还必须指定相应的数据维度 (eVar)。例如，如果要包含 eVar2 查看，则必须列出一个带值的 eVar2。 |
| eVarN视图 | eVarN被查看的次数。N的有效值为整数-250。 |
| 价格 | 产品价格。 |
| 订购 | 订购次数。 |
| 产品查看次数 | 产品查看次数。 |
| 数量 | 售出件数。 |
