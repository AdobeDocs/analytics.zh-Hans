...
1. 现在，将这个新的数据源“映射”到我们在[配置成功事件](/help/admin/admin/c-success-events/t-success-events.md)中创建的自定义事件。
...
例如，可添加这些[计算指标](https://experienceleague.adobe.com/docs/analytics/components/calculated-metrics/calcmetric-workflow/cm-build-metrics.html?lang=en#calculated-metrics)：
