...
1. 现在，将此新数据源“映射”到我们在中创建的自定义事件 [配置成功事件](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/conversion-var-admin/c-success-events/t-success-events.md).
