---
description: 以下指标将作为AppDigiges集成的一部分进行同步。
seo-description: 以下指标将作为AppDigiges集成的一部分进行同步。
seo-title: 量度和维度
title: 量度和维度
uuid: 419a9031-1291-4ec0-a2 e1-93993858991a
index: y
internal: n
snippet: y
...
以下指标将作为AppDigiges集成的一部分进行同步。

| 量度 | 描述 |
|---|---|
| 应用商店下载 | 移动应用程序下载次数。 |
| App Store购买(在应用程序中) | 应用程序内购买的数量。 |
| 应用商店排名 | 用于定义平均AppDigit计算量度。不直接使用。 |
| 应用商店排名因素 | 用于定义平均AppDigit计算量度。不直接使用。 |
| App Store 排行榜 | 用于定义平均AppDigit计算量度。不直接使用。 |
| App Store 排名因素 | 用于定义平均AppDigit计算量度。不直接使用。 |
| App Store收入(应用程序) | 应用程序内收入额。 |
| App Store Revenue(一次关闭) | 与应用程序购买关联的收入额。 |
| App Store Preralies(应用程序) | 已弃用。 |
| App Store版税(一次性) | 已弃用。 |

以下保留分类维度由appDigiges对象ID保留eVar的数据连接器向导创建。

| 分类维度 | 描述 |
|---|---|
| 国家/地区名称 | 与应用程序商店活动相关的国家/地区名称。 |
| 设备名称 | 与应用程序商店活动相关的移动设备名称。 |
| Appstore名称 | 报告活动的应用程序的名称。 |
| 应用程序名称 | 移动应用程序的名称。 |
| 应用程序内名称 | 应用程序内购买的项目。 |
...
<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> 计算量度 </th> 
   <th colname="col2" class="entry"> 描述 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> 应用商店平均排名(数字) </td> 
   <td colname="col2"> <p>平均应用程序排名。该计算量度由以下公式定义： </p> <code> [App&amp; amp；nbsp；商店和市场；nbsp；排名]和amp；nbsp；/amp；nbsp；[App&amp; amp；nbsp；商店和市场；nbsp；排名和上限；nbsp；Divisor] </code> <p>注意：每个类别和国家/地区的应用程序数量在应用商店之间有所不同。如果您的应用程序排名低于此阈值，则应用程序排名不可用。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 应用商店平均评分 </td> 
   <td colname="col2"> 平均应用程序等级。此计算量度是使用以下公式定义的： <code> [App&amp; amp；nbsp；商店和市场；nbsp；评分]和amp；nbsp；/amp；nbsp；[App&amp; amp；nbsp；商店和市场；nbsp；评级和控制；nbsp；Divisor] </code> </td> 
  </tr> 
 </tbody> 
</table>

## 每个AppDigiges指标的相关维度 {#section-cd356d3dce04412893beed345305c247}
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col10"> 应用商店平均排名 </td> 
   <td colname="col11"> App Store Avg.评级 </td> 
  </tr> 
  <tr> 
   <td> 国家/地区名称 </td> 
