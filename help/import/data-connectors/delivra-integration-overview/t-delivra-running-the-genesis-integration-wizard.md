...
1. 单击 **数据连接器** UI左侧“ **合作伙伴列表** ”顶部的“字母顺序”选项卡，然后找到 **Delvra** 图标。
1. 将 **Delvra** 图标拖到Analytics报告套件中的空插件槽中，启动数据连接器集成向导。
1. 在Delvra集成介绍页面上，查看文本，然后选中该复选框以接受与集成相关的费用，然后单击 **下一步**。
...
<table id="table_74EC1EEBE7A548AB878AA40187EBCD30"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>指定您的Delvra帐户ID(由Delivra分配给您的单位的唯一标识符)，然后单击 <b>下一步</b> 以继续执行向导的步骤3。 </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>指定将电子邮件共享到社交网络的次数，然后单击 <b>“下一步”</b> 继续执行向导的步骤6。 </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>单击 <b>“完成</b> ”以完成集成。 </p> <p><b>重要说明：</b> 在单击 <b>“完成</b>”之前，Analytics才会保存集成设置。 </p> </td> 
  </tr> 
 </tbody> 
</table>
