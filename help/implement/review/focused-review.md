...
## 2.确保您的KPI量度和变量仍能正常运行

请记住，随着时间的推移，代码更新可能会产生意想不到的结果。您需要确保与 [5大KPI](/help/implement/review/define-kpis.md) 仍能正常工作。 理想情况下，此操作会在网站发布后立即执行；如果你最近几个月没做过，那就做吧 *now*. 请按以下步骤执行此操作：
...
*有关如何确保量度和变量正常运行的更多详细信息，请参阅 [阅读这些提示](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics-discussions/my-five-best-tips-for-keeping-adobe-analytics-humming/td-p/388608) Adobe Analytics冠军莎拉·欧文。*
