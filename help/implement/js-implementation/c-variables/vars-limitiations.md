...
>[!NOTE]
>
>请参阅[配置变量](/help/implement/js-implementation/c-variables/configuration-variables.md)和[页面变量](/help/implement/js-implementation/c-variables/page-variables.md)，以深入了解最常见的 Analytics 变量。
