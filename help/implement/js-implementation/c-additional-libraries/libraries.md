...
<table id="table_B01E5B7E5DEB42A28AB851E640A6F08E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>所有 Experience Cloud 客户均有权访问<a href="https://marketing.adobe.com/resources/help/en_US/dtm/" format="https" scope="external">动态标签管理</a>，它也是将所有解决方案的 JavaScript 和 HTML 页面标签部署到您网站的标准方法。 </p> <p>至于实施 JavaScript 和 HTML 测量的其他方法，请参阅 <a href="https://marketing.adobe.com/resources/help/en_US/sc/implement/" format="http" scope="external">Analytics 实施指南</a>。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>您可以使用 Web 服务器上的本地 PHP 和 Java 库来发送分析数据。 </p> <p>通过数据插入 API，可使用 HTTP POST 和 GET 将 XML 数据直接发送至数据收集服务器，而借助数据源可将带分隔符的点击数据直接发送至 Analytics。 </p> 
    <ul id="ul_B602F4D6610D46D6BA65F943E5BA296C"> 
     ...
     <li id="li_74B5B70A2E7349EE9FB9721442D0C845"> <a href="https://marketing.adobe.com/developer/documentation/data-insertion/c-data-insertion-api" format="https" scope="external"> 数据插入 API</a> </li> 
     <li id="li_45F309B87FFC40DF9EF0F263C3FB416A"> <a href="https://marketing.adobe.com/resources/help/en_US/sc/datasources/" format="http" scope="external"> 数据源</a> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>使用 ActionScript 的 Flash 应用程序可在桌面和 Web 上进行测量。 </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/flash/oms_sc_appmeasure_flash.pdf" format="http" scope="external"> Flash、Flex 和 OSMF AppMeasurement</a> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>以下指南对在所有平台进行视频测量进行了介绍： </p> 
    <ul id="ul_5C56F82F45264F63ABA184C48B27EE18"> 
     <li id="li_140B692CA3BE476BA024C37E7AE4872F"> <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/" format="http" scope="external">心率视频测量</a>（最新版本） </li> 
     <li id="li_021D77CB25A54647A71F4AE7144EE788"> <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/video/" format="http" scope="external"> 里程碑视频测量</a> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
