...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list[].value` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list[].value` | 全部连接 `value` 每个相应的字符串 `list[]` 阵列 [列表变量](../vars/page-vars/list.md). |
