...
<table id="table_F23FB0B284E74B66A107B1D69D22A51C">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>确定是否收集访客单击图数据。 </p> <p>请参 <a href="../../../vars/config-vars/trackinlinestats.md">阅trackInlinestats</a>。 </p> </td>
  </tr>
  <tr>
   <td colname="col1"> Track download links </td>
   <td colname="col2"> <p>跟踪指向网站上可下载文件的链接。 </p> <p>请参 <a href="../../../vars/config-vars/trackdownloadlinks.md">阅trackDownloadLinks</a>。</p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> Download Extensions </td> 
   <td colname="col2"> <p>如果您的站点包含指向具有任何列出扩展名的文件的链接，则这些链接的URL将以报告显示。 </p>请参 <a href="../../../vars/config-vars/linkdownloadfiletypes.md">阅linkDownloadFileTypes</a>。 </p> </td>
  </tr>
  <tr> 
   <td colname="col1"> Track outbound links </td>
   <td colname="col2"> <p>确定单击的任何链接是否为退出链接。 </p> <p>请参 <a href="../../../vars/config-vars/trackexternallinks.md">阅trackExternalLinks</a>。 </p> <p><b>单页面应用程序注意事项：</b>由于某些 SPA 网站的编码方式，指向 SPA 网站上页面的内部链接的外观可能与出站链接类似。 </p> <p>您可以使用以下方法之一跟踪来自 SPA 网站的出站链接： </p>
  ...
  <tr>
   ...
   <td colname="col2"> <p>保留查询字符串。 </p> <p>请参 <a href="../../../vars/config-vars/linkleavequerystring.md">阅linkLeaveQueryString</a>。 </p> </td>
  </tr>
 </tbody>
</table>
