...
可以使用XDM的[`identityMap`](https://experienceleague.adobe.com/en/docs/experience-platform/collection/identity/identity-map)扩展身份数据以支持自定义ID和多个命名空间。 Adobe建议将ECID用作Analytics的主要标识符，并将其他身份管理选项用于高级方案。
