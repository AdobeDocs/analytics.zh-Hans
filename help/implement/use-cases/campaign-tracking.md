...
1. [设置或调整您的 Adobe Analytics 实施以包含跟踪代码数据](#include-campaign-variables-in-your-implementation)
...
无论您决定如何创建或生成跟踪代码，通过备妥一致的系统，在您要将跟踪代码组合在一起以供报告时，您的组织均可事半功倍。 通过结构一致的跟踪代码，您可创建[分类规则](/help/components/classifications/crb/classification-rule-builder.md)，以使您可洞察各类性能。
