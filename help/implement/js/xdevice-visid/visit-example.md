...
| 服务器调用 | 操作 | 访客ID Cookie | 访客ID变量 | 有效访客ID | 访问页面数量 | 访问量 |
|--- |--- |--- |--- |--- |--- |--- |
| 1 | 访客单击营销电子邮件中的链接并从家庭计算机访问您的网站。 该访客过去曾访问过您的网站7次。 | 1 | - | 1 | 1 | 8 |
| 2-8 | 访问您网站上的其他7个页面。 | 1 | - | 1 | 2-8 | 8 |
| 9 | 在家庭计算机上进行身份验证。 | 1 | CID1 | CID1 | 9 <br>（这是 CID1 的首次点击，因此会接管访客 ID 1 并继续访问其访客轮廓。） | 8 |
| 10 | 访问额外1个页面。 | 1 | CID1 | CID1 | 10 | 8 |
| 11 | 在办公室从笔记本电脑打开网站。 此访客在使用此设备之前未访问过您的网站。 | 2 | - | 2 | 1 | 1 |
| 12 | 在笔记本电脑上进行身份验证。 | 2 | CID1 | CID1 | 1 | 9 |
| 13 | 查看了1个其他页面。 | 2 | CID1 | CID1 | 2 | 9 |
...
首次关联之后，访问次数恢复正常，因为访客通过其浏览器 Cookie 进行关联。 如果访客稍后查看您的网站，接着进行身份验证，访客计数不会虚增，因为有效的访客 ID 在身份验证后不会发生更改。
