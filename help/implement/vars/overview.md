...
Adobe 提供了多种实施 Adobe Analytics 的方法。每个页面都提供一个部分，介绍如何在Adobe Experience Platform和AppMeasurement for JavaScript中使用标记实施变量。
...
2. 使用数据层填充 Analytics 变量。如果在Adobe Experience Platform中使用标记，则可通过使用数据元素，然后将数据元素分配到变量来轻松完成此任务。 请参阅[数据元素](https://experienceleague.adobe.com/docs/experience-platform/tags/ui/data-elements.html)。
