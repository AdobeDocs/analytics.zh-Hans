...
2. 使用数据层填充 Analytics 变量。如果使用 Launch，则可以通过使用数据元素并将相应数据元素分配到变量来轻松完成此任务。请参阅 Launch 用户指南中的[数据元素](https://experienceleague.adobe.com/docs/launch/using/reference/manage-resources/data-elements.html?lang=zh-Hans)。
