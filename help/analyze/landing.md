...
Adobe Analytics 的登陆页面将 [!DNL Analysis Workspace] 与 [!DNL Reports & Analytics]（已停用）融入 [!DNL Workspace] 伞形结构下的单个界面和访问点。它配有项目管理器主页、更新的报告菜单、现代化报告，以及学习部分，帮助您更高效地入门。以下是一段视频概述：
