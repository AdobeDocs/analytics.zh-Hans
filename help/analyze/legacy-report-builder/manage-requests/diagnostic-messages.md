...
![带有感叹号的红色三角形图标，表示请求刷新失败。](assets/icon_notice_warn.gif)当请求无法成功刷新时显示此警报。 错误记录在诊断列中，以指出失败的可能原因。请查看[疑难解答部分](/help/analyze/legacy-report-builder/troubleshoot.md)，以获取有关所选失败消息的帮助。
