...
| 贡献分析 | 使用 Analysis Workspace 发现数据中隐藏的模式，以解释统计异常并识别意外客户行为、越界值以及跨受众区段量度的突增或突减背后存在的关联。 | [贡献分析](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md#contribution-analysis) 在 [异常检测概述](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md) |
