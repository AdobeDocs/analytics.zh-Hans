...
+++是否所有Analytics客户都有权访问管理工具Activity Map启用页面？
...
+++Activity Map会在页面上扫描Adobe Analytics多长时间？
...
+++我能否通过数据馈送导出Activity Map上下文数据变量？
是的。的 [数据列](/help/export/analytics-data-feed/c-df-contents/datafeeds-reference.md) Activity Map使用的 `clickmaplink`, `clickmaplinkbyregion`, `clickmappage`和 `clickmapregion`.
+++
