...
* 支持该 **[!UICONTROL Remember my login]** 功能。
...
1. 单击 **[!UICONTROL Download Activity Map]**.
1. 单击 **[!UICONTROL Install the Activity Map Plug-in]**.
...
1. 单击 **[!UICONTROL Install Now]**.
1. 单击右 **[!UICONTROL Open Menu]** 上方的图标，然后选择 **[!UICONTROL Add-Ons]**。 ![](assets/firefox_install3.png){width=&quot;250px&quot;}
