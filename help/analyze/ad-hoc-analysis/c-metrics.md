...
请参阅 Analytics 参考[](https://docs.adobe.com/content/help/en/analytics/components/variables/metrics/metricslist.html)中的&#x200B;*量度定义*，以了解如何在 [!DNL Experience Cloud] 中使用量度的相关信息。

You can use the [!UICONTROL Organize Metrics] tool to create new folders for your metrics. 然后，可以按所需的任意方式对量度进行分组。通过使用组织器，可以使用拖放方式将现有量度复制到自定义文件夹。
...
1. 在工具窗 [!UICONTROL Metrics] 格中，单击 **[!UICONTROL More Actions]**。( ![](assets/tools_icon.png)

   )
1. 单击 **[!UICONTROL Organize Metrics]**.
...
1. 在窗 [!UICONTROL Metrics] 格中，单 **[!UICONTROL More Options]**&#x200B;击，然后 **[!UICONTROL Calculated Metrics Builder]**。
