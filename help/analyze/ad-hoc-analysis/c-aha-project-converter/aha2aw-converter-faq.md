 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>答：请注意，在工作区中图表和图形称作“可视化图表”。 </p> 
    <ul id="ul_597F5AB826EF434295D0CABD0313CAD5"> 
     ...
     <li id="li_1FF5B3FD9E424E7190AF03FD4DD9D654"><b>流量报表</b>：会将流量移动到单独的面板中以保留范围和分段。可以在“流量”设置下包含或排除重复实例。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_15D5B17461E2402DB07DF8B0A10AAC37"> 
     ...
     <li id="li_0E6DF6D44EA448A4A212BA2BB8E342CF">在工作区中，会在表列级别应用 Ad Hoc Analysis 表区段。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_A24AB597F3CE4847AF00D49A9A72A395"> 
     <li id="li_24FD18AF64114445939C4FBC03F2D406">Ad Hoc Analysis 中的“最近 X 天”日期范围<i>不包含</i>当天，然而在 Analysis Workspace 中，该日期范围<i>包含</i>当天。因此，像“最近 90 天”这样的日期范围在两个工具中得到的结果可能并不完全一致。可改为应用 Analysis Workspace 中的“最近 X 天<b>整</b>”日期范围。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>您可以通过单击编辑（铅笔）图标，在<a href="https://docs.adobe.com/content/help/zh-Hans/analytics/components/calculated-metrics/cm-overview.html"  >计算量度生成器</a>中编辑分配类型。 </p> </td> 
  </tr> 
  <tr> 
