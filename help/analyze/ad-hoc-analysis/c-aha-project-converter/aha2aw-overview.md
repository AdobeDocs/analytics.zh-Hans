...
* 可以将您的项目转换到先进的 Analytics 报表工具 [Analysis Workspace](https://docs.adobe.com/content/help/zh-Hans/analytics/analyze/analysis-workspace/analysis-workspace-features.html)，该工具将通过新的可视化图表及其他符合实际需要的重要功能不断进行增强。
