...
管理员可以编辑任何区段，与群组[共享区段](https://marketing.adobe.com/resources/help/en_US/analytics/segment/t_seg_share.html)，并为组织[设置权限](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_rights.html)以访问区段。
