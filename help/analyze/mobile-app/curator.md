...
* 他们有效的Adobe Analytics登录名
* 您已为他们正确创建了移动记分卡，并与他们共享这些记分卡。
* 他们可以访问Analysis Workspace和记分卡所基于的报表包
* 他们有权访问记分卡包含的组件。 注意：在将记分卡共享到自动与收件人共享嵌入的组 **件时，您可以选择一个选项**。
...
1. 帮助执行用户下载和安装应用程序。 为此，请根据您的执行用户是使用iOS还是Android设备，提供以下步骤来扩展对他们的访问。
   ...
   **对于iOS上的执行用户：**
   ...
   1. 单击以下公共链接(在“工具” **&gt;“移动应用程序”下** 的Analytics中也可 **用该链接**):
