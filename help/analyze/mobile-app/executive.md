...
1. 获取记分卡更新。 如果记分卡不包含您可能感兴趣的所有量度或划分，请联系您的 Analytics 团队来更新记分卡。 更新后，您可以下拉屏幕上的信息卡进行刷新，并加载最近添加的数据。
...
| 术语 | 定义 |
|--- |--- |
| 使用者 | 在移动设备上查看 Analytics 中的关键量度和洞察的执行用户画像 |
| 策划人 | 通晓数据的用户画像，能够从 Analytics 中发现和分发洞察，并配置供消费者查看的记分卡 |
