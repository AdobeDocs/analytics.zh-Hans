...
| **[Report Builder](https://experienceleague.adobe.com/docs/analytics/analyze/report-builder/home.html)** | Mac、Windows和Web浏览器支持适用于Microsoft Excel的新Report Builder加载项。 通过 Report Builder，您可从插入 Excel 工作表的 Adobe Analytics 数据构建自定义的请求。请求可动态引用工作表中的单元格，并且您可更新和自定义 Report Builder 展示数据的方式。 |
| **[旧Report Builder](/help/analyze/legacy-report-builder/home.md)** | 旧版Report Builder是Microsoft Excel的加载项，仅在Microsoft Windows上受支持。 通过 Report Builder，您可从插入 Excel 工作表的 Adobe Analytics 数据构建自定义的请求。请求可动态引用工作表中的单元格，并且您可更新和自定义 Report Builder 展示数据的方式。 |
