...
包含提供关于访客在访问您的网站前来自哪里的洞察信息的报表。除非在报表包设置下正确设置[内部 URL 过滤器](../../admin/admin/internal-url-filter-admin.md)，否则这些报表无法正常工作。
...
>[!NOTE]
>
>如果在此帮助页面上找不到您的报表，则可能是因为管理员重命名或调整了文件夹。请参阅管理员用户指南中的[菜单自定义](/help/admin/admin/customize-menus.md)。
