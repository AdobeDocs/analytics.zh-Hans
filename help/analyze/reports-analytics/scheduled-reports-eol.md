...
2022 年 4 月 21 日，我们宣布弃用计划报告的多项功能，为之前宣布的 [Reports &amp; Analytics 生命周期结束](https://www.adobe.com/go/analytics_rnaeol_en)做准备。这些功能包括计划新报告和新数据提取的能力。为响应客户延期请求并简化从 Reports &amp; Analytics 的过渡，我们决定将这些功能的访问权限延长至 **2023 年 1 月 31 日**。请注意，报告和数据提取的到期窗口仍为九个月；除非重新激活计划，否则报告和数据提取交付将在此期限结束时暂停。
