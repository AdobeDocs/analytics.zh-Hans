...
**[!UICONTROL Analytics]** >组 **[!UICONTROL 件]** >所 **[!UICONTROL 有组件]** > **[!UICONTROL 目标]**

“[!UICONTROL 添加/编辑目标]”页上的字段和选项描述。

| 元素 | 描述 |
| --- | --- |
| [!UICONTROL 目标名] | 提供目标名称，该名称显示在[!UICONTROL 管理目标]页面上。 |
