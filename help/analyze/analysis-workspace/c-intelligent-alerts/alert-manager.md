...
seo-title: 警报管理器
title: 警报管理器
uuid: 4c7afc-61c5-4239-ab8 e-88b8 f87438 ef
...
* 复制警报。
* 启用/禁用警报。
* **续订**&#x200B;警报过期日期。When one or more alerts are selected, they can be renewed by clicking **Renew**.This extends their expiration dates to be 1 year from the day Renew was clicked, regardless of their original expiration date.
* 将警报导出为 .CSV 文件。
* 双击警报标题以编辑警报。
* 搜索警报。
* 向其他报表包添加警报。
