...
这些标准模板将指导您逐步了解在Workspace中构建第一个分析的常用术语和步骤。 新项目模式中的示例项目可用作标准模板，并替换当前存在于列表中没有其他项目的新用户的示例项目。

* **培训教程——内部搜索分析**:“内部搜索”教程可帮助您了解访客在网站或应用程序上查找的内容，但不能查找。 分析此类数据可以发掘内容优化机会。
