...
* 将美国/加拿大的数据与全球其他地区的数据进行分段
* 并排比较“人员”和“独特访客”指标
* 请参阅“压缩率”，这是一个计算量度，用于计算“人员”量度小于独特访客的百分比
* 比较客户使用的设备类型总数
* 查看每人使用的平均设备数
* 了解如何在“人员”量度中使用区段栈叠
...
此模板可让您查看重要的跨设备性能数据。它仅适用于有权访问[Cross-Device Analytics](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html) (CDA) 的客户。
