...
| 展开 | 此选择显示用于创建空白项目或移动记分卡、[查看培训教程](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-introduction)或[查看发行说明](/help/release-notes/latest.md)的选项。 |
...
在项目中，菜单提供管理项目、添加组件、查找帮助等选项。您还可以通过键盘[快捷键](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys)访问每个菜单选项。
...
| 图标 | 功能 |
|---|---|
| ![面板图标](https://spectrum.adobe.com/static/icons/workflow_18/Smock_WebPage_18_N.svg) | [个面板](/help/analyze/analysis-workspace/c-panels/panels.md) |
| ![可视化图标](https://spectrum.adobe.com/static/icons/workflow_18/Smock_GraphBarVertical_18_N.svg) | [可视化图表](/help/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.md) |
...
根据您为项目选择的起点，您在画布中首先使用[自由格式表](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table)或[空白面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/blank-panel)。 最快开始分析的方法是选择一个或多个组件，然后将其拖放到项目画布中。数据表会自动为您呈现。 [了解更多](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table)有关构建表的不同选项，或利用可用的[培训教程](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/home)获取有关构建您的第一个项目的更多指导。
