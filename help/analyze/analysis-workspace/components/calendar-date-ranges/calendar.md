...
您可以创建自定义日期范围。请参阅[创建日期范围](create.md)，了解可用于创建日期范围的各种选项。然后，您可以在[日期范围构建器](create.md#date-range-builder)中构建、修改和保存日期范围。
...
See ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Calendar and date ranges overview](https://video.tv.adobe.com/v/328022?captions=chi_hans&quality=12&learn=on){target="_blank"} for a demo video.
