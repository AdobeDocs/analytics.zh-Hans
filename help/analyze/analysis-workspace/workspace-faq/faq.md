...
<table id="table_BC4237EC03FF42579CC736498D6654F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>无需特殊实施。 分析工作区适用于所有使用Analytics Standard或Premium的公司。 但是，对内容（如报表包和项目组件）的标准权限适用，并适用于创建和共享项目。 请参阅<a href="/help/analyze/analysis-workspace/workspace-faq/frequently-asked-questions-analysis-workspace.md"  >管理和访问要求</a>。 </p> </td> 
  </tr> 
  <tr> 
