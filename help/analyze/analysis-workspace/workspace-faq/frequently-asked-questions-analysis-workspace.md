...
| 要求 | 描述 |
|--- |--- |
| 产品SKU | 您必须安装了 Adobe Analytics Standard 或 Adobe Analytics Premium。如果您只能单独访问 Reports &amp; Analytics 产品，请与您的客户团队联系，购买 Adobe Analytics 解决方案。 |
| 管理员 | 拥有 Analysis Workspace 的完全访问权。 |
| 用户 | 要启用对Analytics中“工作区”选项卡的访问权限，管理员必须创建具有“分析工作区访问权限”的产品用户档案，并在“管理控制台”中将用户 [添加到该](/help/admin/admin-console/permissions/product-profile.md)。 |
