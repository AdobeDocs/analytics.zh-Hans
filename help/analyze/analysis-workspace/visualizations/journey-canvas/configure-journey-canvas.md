...
您可以选择节点，并显示历程中紧跟其之后的排名最前的直接或最终维度项目。 您可以将前 3 名维度项作为单独的节点添加到历程画布中，也可以在自由格式表中查看所有最顶级的维度项。
...
您可以选择节点，并显示历程中紧靠其前面的排名最前的直接或最终维度项目。 您可以将前 3 名维度项作为单独的节点添加到历程画布中，也可以在自由格式表中查看所有最顶级的维度项。
...
* 在画布上，选择要合并的节点，右键单击其中一个选定的节点，然后选择&#x200B;**合并节点**。 您可以合并的次数是否存在限制？
