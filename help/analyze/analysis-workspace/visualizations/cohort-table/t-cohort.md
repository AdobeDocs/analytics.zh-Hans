...
1. （可选）调整 **[!UICONTROL 同类群组表设置]** 单击齿轮图标。
...
与Analysis Workspace中的其他可视化一样，您可以将同类群组可视化下载为CSV或PDF文件。 有关更多信息，请参阅 [下载PDF或CSV文件](/help/analyze/analysis-workspace/curate-share/download-send.md).
