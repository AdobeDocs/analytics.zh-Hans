...
1. 您现在可以：
   ...
   * 通过双击此地图或使用滚动轮将&#x200B;**缩放**&#x200B;到此地图中以放大某些区域。 映射根据光标放置的位置进行缩放。 通过缩放交互，所需的维度（国家/地区>州/省>城市）会根据缩放级别自动更新。
   ...
   * 通过按住&#x200B;**Ctrl**&#x200B;键并移动地图，以2D或3D形式[!UICONTROL 旋转]地图。

   * **使用下面描述的**&#x200B;设置[将](/help/analyze/analysis-workspace/visualizations/map-visualization.md#section_5F89C620A6AA42BC8E0955478B3A427E)切换为其他视图，例如热图。 请注意，气泡视图是默认设置。
