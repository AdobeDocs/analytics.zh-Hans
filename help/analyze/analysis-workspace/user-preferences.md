...
| **数据** |  |  |
|  | [报表包](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/panels.html?lang=zh-Hans?#report-suite) | <ul><li>最近（默认）</li><li>从列表中选择特定报表包</li></ul> |
