...
Analysis Workspace中为[!UICONTROL Adobe Analytics]提供了以下面板类型：
...
观看演示视频的![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [下拉列表区段](https://video.tv.adobe.com/v/23877?quality=12&learn=on){target="_blank"}。
