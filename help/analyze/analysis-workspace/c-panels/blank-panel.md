...
*本文记录了&#x200B;**Adobe Analytics**中的空白面板。<br/>查看本文的&#x200B;**Customer Journey Analytics**版本的[空白面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/blank-panel)。*
