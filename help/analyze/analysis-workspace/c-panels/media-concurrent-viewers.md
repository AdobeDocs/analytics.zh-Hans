...
| 如果我在分钟级别的粒度下查看超过 1 天的数据，应该怎么办？ | 要在分钟级别的粒度上一次性查看最多 1 个月的数据，您可以使用 Analytics 2.0 API。有关更多信息，请参阅[使用 Analytics 2.0 API 获取并行查看者 JSON 报表数据](https://docs.adobe.com/content/help/zh-Hans/media-analytics/using/media-reports/media-default-reports/get-concurrent-json20.html)。 |
