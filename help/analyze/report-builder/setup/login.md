---
description: 了解如何使用您的Experience Cloud登录帐户登录以Report Builder。
...
>[!IMPORTANT]
>
>Report Builder版本5.6.47及更高版本仅支持Experience Cloud登录，不支持旧版登录（如Site Catalyst单点登录或标准登录）。 **到2021年7月22日，所有Report Builder用户都必须将Report Builder加载项更新到版本5.6.47或更高版本，其中包括登录流程的关键更新。**
...
1. 单击&#x200B;**[!UICONTROL 登录]**。可让您登录的其他操作包括：
   ...
   * 单击&#x200B;**[!UICONTROL “创建”]**。
   * [在请求管理器中选择一个请求](/help/analyze/report-builder/manage-requests/r-arb-manage-requests.md)，然后单击“添 **** 加 **[!UICONTROL 器管理]**”。
   * 在Excel中双击请求。
