...
>[!NOTE][!UICONTROL 实时报表]与以前发布的[包括当前数据](https://docs.adobe.com/content/help/en/analytics/analyze/report-builder/options.html)（“数据新近度”）功能不同，后者通过在最终确定数据之前显示数据来减少标准报告的延迟。
