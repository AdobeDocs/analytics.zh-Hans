...
量度是数字值，它们包含有关网站上活动的定量信 [!UICONTROL Page Views]息， [!UICONTROL Visitor Profile]如 [!UICONTROL Click-throughs]、、 [!UICONTROL Reloads]、 [!UICONTROL Average Time Spent]、 [!UICONTROL Date]、 [!UICONTROL Units]、等等。 Report Builder 将量度组织在多个组中，这些组遵循 Analytics 中的标准分组原则：
