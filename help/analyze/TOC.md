...
+ 旧版 Report Builder {#legacy-report-builder}
  ...
  + 数据请求 {#data-requests}
    ...
    + [导入已添加书签的报告和功能板小型报告](legacy-report-builder/data-requests/import-bookmarked.md)
    + 日期范围 {#date-ranges}
  ...
  + 布局 - 请求向导第 2 步 {#layout}
    ...
    + 量度和维度 {#metrics-dimension}
      ...
      + [在同一请求中组合使用流量和商业量度](legacy-report-builder/layout/c-metrics-dimensions/grouped-metrics.md)
  ...
  + 管理请求 {#manage-requests}
    ...
    + [用于创建和编辑请求的离线模式](legacy-report-builder/manage-requests/offline-mode.md)
