...
| [!UICONTROL **常用于**] | 显示5个最常用于您正在查看的组件的组件。 此列表基于过去90天的数据。 只显示您有权查看的组件。 |
| [!UICONTROL **类似于**] | 显示5个组件，其标签与您正在查看的组件类似。 只显示您有权查看的组件。 |
...
>[!AVAILABILITY]
>
>本文中描述的功能处于版本的有限测试阶段，可能尚未在您的环境中提供。 当该功能正式发布时，将删除此说明。有关 Analytics 发布流程的信息，请参阅 [Adobe Analytics 功能发布](/help/release-notes/releases.md)。

## 发布的有限测试阶段部分 {#release-limited-testing-section}

>[!AVAILABILITY]
>
>此部分中描述的功能处于版本的有限测试阶段，可能尚未在您的环境中提供。 当该功能正式发布时，将删除此说明。有关 Analytics 发布流程的信息，请参阅 [Adobe Analytics 功能发布](/help/release-notes/releases.md)。
