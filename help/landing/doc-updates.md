...
| 日期 | 描述 |
|---|---|
| September 28, 2019 | 有关Javascript实现 [的配置变量的新文章](https://docs.adobe.com/content/help/en/analytics/implementation/javascript-implementation/variables-analytics-reporting/configuration-variables.html) |
