...
[!UICONTROL 单页面访问量]量度显示[页面](../dimensions/page.md)维度项目在整个访问期间仅包含单个唯一值的访问次数。 当您想要查看短期访问次数的维度，但没有规则的严格程度（如[[!UICONTROL 跳出次数]](bounces.md)）时，此量度非常有用。
...
此设置指定是否将重复实例计入报表中。有关更多信息，请参阅[计数重复实例](/help/components/metrics/count-repeat-instances.md)。