...
| [[!UICONTROL 页面逗留时间 — 分段统计]](../dimensions/time-spent-on-page.md) | 粒度维度分成10个不同的范围；但是，分段维度仅计算页面查看次数（不包括链接事件）。 这是一个点击级别的维度。 范围包括：<ul><li>少于 15 秒</li><li>15 至 29 秒</li><li>30 至 59 秒</li><li>1 至 3 分钟</li><li>3 至 5 分钟</li><li>5 至 10 分钟</li><li>10 至 15 分钟</li><li>15 至 20 分钟</li><li>20 至 30 分钟</li><li>超过 30 分钟</li></ul> | Analysis Workspace |
...
任何量度。 此维度将显示发生事件的具体点击的逗留时间。 逗留时间越长意味着访客在发生事件的页面（点击）中停留的时间越长。
