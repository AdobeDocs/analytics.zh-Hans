...
流媒体服务质量量度为通过流媒体收集库收集的数据提供补充报表功能。 这些量度需要&#x200B;**[!UICONTROL 适用于流媒体的Adobe Analytics加载项]**。 有关详细信息，请联系您的Adobe客户团队。

若要使用这些量度，请在[[!UICONTROL 媒体报表]](/help/admin/tools/manage-rs/edit-settings/media-management.md)下为报表包启用&#x200B;**[!UICONTROL 媒体质量]**。
