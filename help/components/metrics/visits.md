...
每个涉及的时段的访问计数。例如，如果您的一个访客在周一晚上 11:45 开始在您的网站上导航，然后在周二凌晨 12:10 发送了他们的最后一个图像请求，您将看到一次同时属于周一和周二的访问。但是，会在总访问次数量度中删除重复计数，从而显示项目日期范围的单次访问。
