...
“独特设备”[指标](overview.md)是一个[跨设备分析](../cda/overview.md)指标，它计算独特的未识别的设备和独特的虚拟设备的数量。 未识别的设备是产生匿名点击的设备。 独特的虚拟设备是按设备识别出的不同人员。
...
1. Sally 想要购买，但更愿意在家用电脑上操作，因为她在那里已经登录。 她在家用电脑上购物。
