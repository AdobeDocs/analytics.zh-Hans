...
| 如何才能找到虚拟报表包的 ID？ | <ul><li>打开 Workspace 项目，单击报表包选择器，然后在搜索框中搜索虚拟报表包的名称。ID 显示在搜索结果中的名称下方：<br>![VRS ID](assets/vrs-id.png)</li><li> 或者，以编程方式显示在[虚拟报表包 API](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/vrs.md) 中。</li></ul> |
