...
## CDA 中的“人员”指标与 CDA 外的“独特访客”指标有何区别？

[人员](/help/components/metrics/people.md)和[独特访客](/help/components/metrics/unique-visitors.md)指标都是为了计算不同的访客（个人）。但仔细考虑就会发现，2 个不同的设备也可能属于同一个人。CDA 将这 2 个设备映射到同一个人，而在 CDA 之外将这 2 个设备记录为 2 个单独的“独特访客”。

## CDA 中的“独特设备”指标与 CDA 之外的“独特访客”指标之间的区别是什么？

这两个指标大体上互相等效。在以下情况下，这两个指标之间存在区别：
...
如果标识符 prop/eVar 值遇到[哈希冲突](/help/implement/validate/hash-collisions.md)，则“已识别的人员”指标的数字可能会稍高一些。
