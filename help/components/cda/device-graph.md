...
如果您打算使用设备图方法来实施 Cross-Device Analytics，则需要满足以下条件。与贵组织内的团队及Adobe客户团队合作，确保满足以下所有条件。
...
* 您的实施必须使用最新版本的Experience CloudID服务(ECID)。 请参阅 [主页](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=zh-Hans) （位于ID服务用户指南中）。 大多数实施使用 [标记](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html) 在Adobe Experience Platform中，可能已部署ID服务。
