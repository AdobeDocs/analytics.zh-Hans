...
* 贵组织必须使用 [Adobe Experience Platform Identity Service专用图](https://business.adobe.com/products/experience-platform/identity-service.html). 另请参阅 [主页](https://experienceleague.adobe.com/docs/experience-platform/identity/home.html) （在Identity Service用户指南中）。
* 您的实施必须使用最新版本的Experience CloudID服务(ECID)。 请参阅 [主页](https://experienceleague.adobe.com/docs/id-service/using/home.html) （位于ID服务用户指南中）。 大多数实施使用 [标记](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html) 在Adobe Experience Platform中，可能已部署ID服务。
