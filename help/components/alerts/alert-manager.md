...
警报管理器的结构类似于[区段管理器](/help/components/segmentation/segmentation-workflow/seg-manage.md)和[计算量度管理器](/help/components/calculated-metrics/workflow/cm-manager.md)。
