...
<table id="table_C18A0F1C9E214EB585A29801BA2400F8"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>由为本报表包启用的 eVar 组成，并且只在通过网页上的 Adobe 代码设置变量时才适用。 </p> <p>请参阅<a href="https://docs.adobe.com/content/help/en/analytics/implementation/home.html"  >实施指南</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>将规则与您添加到<span class="wintitle">“营销渠道管理器”</span>页面上的营销渠道相关联。 </p> <p>请参阅<a href="/help/components/c-marketing-channels/mark-channel-mgr/c-channels.md"   >添加营销渠道</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>按照“管理工具”中对报表包的定义，引用 URL 与内部 URL 筛选器不匹配。您可以将此设置与“<span class="term">页面 URL</span>”和“<span class="term">存在</span>”一起使用来设置一个通用规则，这样就不会有访问登陆报表中的<a href="/help/components/c-marketing-channels/mc-faq/c-faq.md#no-channel-identified" >未识别渠道</a>区域。 </p> </td> 
  </tr> 
  <tr> 
