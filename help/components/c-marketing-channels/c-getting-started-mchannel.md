...
1. 单击&#x200B;**[!UICONTROL 编辑设置]** > **[!UICONTROL 营销渠道]** > **[!UICONTROL 营销渠道管理器]**。
   ...
   >[!NOTE]
   >
   >当您访问“管理工具”中的渠道配置应用程序时，会自动显示[!UICONTROL 营销渠道: 自动设置]页面。 （请参阅[营销渠道管理员](/help/admin/tools/manage-rs/edit-settings/marketing-channels/c-channels.md)。） 如果您的报表包包含一个或多个营销渠道，则不会显示此页面。 除非您选择另一个不含营销渠道的报告包，否则您不能再访问此页面。
