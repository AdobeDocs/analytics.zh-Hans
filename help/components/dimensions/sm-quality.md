...
流媒体服务质量维度提供与访客使用的内容质量相关的报表。 这些维度需要&#x200B;**[!UICONTROL 适用于流媒体的Adobe Analytics加载项]**。 有关详细信息，请联系您的Adobe客户团队。

若要使用这些维度，请在[[!UICONTROL 媒体报告]](/help/admin/tools/manage-rs/edit-settings/media-management.md)下为报表包启用&#x200B;**[!UICONTROL 媒体质量]**。
