---
title: 回访频率
description: 当前访问与上次访问之间按时间段划分的时间长度。
feature: Dimensions
...
维度项目包括基于时间的分段，具体取决于自上次访问以来经过的时间。
...
设置项目的日期范围时，通常会看到维度项目归因于日期范围外的访问。 例如，访客在 7 月访问网站，然后在 9 月的同一天回访两次。 9 月份回访频率维度会在“超过 1 个月”下显示一次访问，并在“小于 1 天”下显示一次访问。
