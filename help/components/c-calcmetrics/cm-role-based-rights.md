...
<table id="table_13F72FD90C964B86BD4B51E6F51ED292"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col02"> 管理员可以创建计算指标，也可以通过创建<a href="https://experienceleague.adobe.com/docs/analytics/admin/user-product-management/user-groups/groups.html"  >组</a>来限制用户创建计算指标的权限。 </td> 
