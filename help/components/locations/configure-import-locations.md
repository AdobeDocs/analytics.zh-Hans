...
1. 在&#x200B;[!UICONTROL **位置属性**]&#x200B;部分中，指定特定于位置帐户的帐户类型的信息。
   ...
   有关配置说明，请展开以下与您在 [!UICONTROL **位置帐户**] 字段。 （此外，还提供其他旧版帐户类型，但不建议这样做。）
   ...
   **帐户类型**
   ...
   | 字段 | 功能 |
   |---------|----------|
   | [!UICONTROL **存储段名称**] | 您要将 Adobe Analytics 数据发送到的 Amazon S3 账户中的存储段。 |
...
1. 选择&#x200B;[!UICONTROL **保存**]。
   ...
   您现在可以将数据导入或导出到您配置的帐户和位置，或从配置的帐户和位置导出数据。
