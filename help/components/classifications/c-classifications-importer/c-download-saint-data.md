...
| 导出数值 2 | 您可以使用导入器，将数值 2 分类导入系统。数值 2 分类很适合用于针对不同项目（例如[!UICONTROL 营销渠道]报表的成本与预算值）随时间变化的变量。请参阅[数值 2 分类](/help/components/classifications/c-numeric-2/c-numeric-2-classifications.md)，以了解有关使用数值 2 分类上载数据的信息。 |
...
有关数据文件结构的详细信息，请参阅[关于分类数据文件](/help/components/classifications/c-classifications-importer/c-saint-data-files.md)。
...
1. 在&#x200B;**[!UICONTROL 下载模板]**&#x200B;选项卡上，指定[数据模板配置](/help/components/classifications/c-classifications-importer/c-download-saint-data.md)。
1. 单击&#x200B;**[!UICONTROL 下载]**。
1. 将模板文件保存到您的本地系统中。
