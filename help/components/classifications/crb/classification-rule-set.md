---
description: 规则集是特定变量的一组分类规则。 将变量应用于规则集。 如果要为一个变量创建多个规则集，必须将每个规则集应用于多个报表包。
title: 分类规则集
...
<table id="table_A5D92409969747E39E041216A5AA32CD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 显示规则集中包含的规则数。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>状态 </p> </td> 
   <td colname="col2"> 显示规则集的活动状态，如“草稿”或“活动”。 活动规则每天处理，通常每月检查一次返回的分类数据。 规则会自动检查新值，并上传分类。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>上次更改 </p> </td> 
   <td colname="col2"> 指示何时编辑规则集。 </td> 
  </tr> 
  <tr> 
...
1. 单击&#x200B;**[!UICONTROL 选择报表包和变量]**。
   ...
   报表包和变量列表中填充了您的登录公司的所有报表包中可用的所有分类变量。 报表包中的单个变量只能属于一个规则集。
