...
| 列 | 描述 |
|---|---|
| **[!UICONTROL 分类集]** | 分类集的名称。 选择名称以[编辑分类集](create-set.md#edit-a-classification-set)。 |
...
* 选择![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL 新建]**&#x200B;以[创建新的分类集](create-set.md#create-a-classification-set)。
...
| 图标 | 操作 | 描述 |
|---|---|---|
| ![编辑](/help/assets/icons/Edit.svg) | **[!UICONTROL 编辑]** | [在分类集生成器中编辑分类集](create-set.md#edit-a-classification-set)。 |
...
| ![Delete](/help/assets/icons/Delete.svg) | **[!UICONTROL 删除]** | 删除分类集。<br/>删除&#x200B;_分类集_？]****[!UICONTROL &#x200B;出现对话框。 无法撤消删除分类集。 任何使用此分类集的计划项目或合并将继续使用此分类集的定义，直至您重新保存计划项目或重新验证计划合并。 选择&#x200B;**[!UICONTROL 删除]**&#x200B;以删除分类集。 |
