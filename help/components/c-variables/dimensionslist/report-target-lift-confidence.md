...
Adobe Target 文档包含有关[提升](https://docs.adobe.com/content/help/zh-Hans/target/using/administer/preferences/estimating-lift-in-revenue.html)和[置信度](https://docs.adobe.com/help/zh-Hans/target/using/reports/settings/average-lift-bounds-and-confidence-interval.html)的更多信息。
