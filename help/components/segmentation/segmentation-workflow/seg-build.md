...
1. **[!UICONTROL Dimension]**:组件从Dimension列表（橙色提要栏）中拖放。
...
1. **[!UICONTROL Experience Cloud发布]**:将Adobe Analytics区段发布到Experience Cloud后，您可以使用该区段在其他激活渠道 [!DNL Audience Manager] 中进行营销活动。 [了解更多...](/help/components/segmentation/segmentation-workflow/seg-publish.md)
