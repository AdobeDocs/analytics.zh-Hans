...
| `country` | 表示点击来源国家/地区的数值 ID。在[国家/地区](/help/components/dimensions/countries.md)维度中用到。使用 `country.tsv` 查找。 | 无符号 smallint |
...
| `geo_city` | 点击来源城市的名称，基于 IP 地址。在[城市](/help/components/dimensions/cities.md)维度中用到。 | char(32) |
| `geo_country` | 点击来源国家/地区的缩写，基于 IP 地址。 | char(4) |
| `geo_dma` | 点击来源人口统计区的数值 ID，基于 IP 地址。在[美国 DMA](/help/components/dimensions/us-dma.md) 维度中用到。 | 无符号 int |
| `geo_region` | 点击来源州/省/直辖市/自治区或地区的名称，基于 IP 地址。在[地区](/help/components/dimensions/regions.md)维度中用到。 | char(32) |
| `geo_zip` | 点击来源的邮编，基于 IP 地址。有助于填充[邮编](/help/components/dimensions/zip-code.md)维度。另请参阅 `zip`。 | varchar(16) |
...
| `page_url` | 点击的 URL。从链接跟踪图像请求中剥离而得。 | varchar(255) |
