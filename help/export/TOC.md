...
+ Analytics 数据馈送 {#analytics-data-feed}
   ...
   + 数据馈送内容 {#data-feed-contents}
      ...
      + [post_product_list中的促销eVar实例查找](analytics-data-feed/c-df-contents/merchandising-evar-lookup.md)
...
+ [Analysis Workspace 下载](https://docs.adobe.com/content/help/zh-Hans/analytics/analyze/analysis-workspace/curate-share/download-send.html)
