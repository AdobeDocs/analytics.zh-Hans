...
| ----------- | ---------- | ------- | ---- |
| **新的 Report Builder 中对安全目标的支持** | Report Builder 插件中已添加新的导出目标。支持以下云存储目标： <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> 由于安全问题，FTP 不再受支持。（文档链接见下文） |  | 2025年6月19日（原为6月18日） |
