...
| 注意事项 | 添加或更新日期 | 描述 |
| ----------- | ---------- | ---------- |
| 更改了Analytics处理通过Experience Edge收集的A4T数据的方式 | 2022 年 31 月 3 日 | 开 **2022年3月7日**，我们更改了处理来自Experience Edge的一些调用的方式，这些调用中包含用于A4T报表的Target内容。 从3月7日开始，已修改所有包含A4T报表内容的点击，以便不将其视为页面查看或链接事件。 **自2022年3月31日起**，我们更改了逻辑，以便更加选择性，从而不会修改标准的页面查看和点击事件。 今后，将修改的唯一事件将是仅具有A4T内容的个性化调用。 |
