...
# 当前的 Adobe Analytics 发行说明（2025 年 10 月版本）
...
| **Adobe Analytics 2.0 API 报告包创建** | 在 Adobe Analytics 中使用 2.0 API 创建报告包。新的 POST 方法取代了 1.4 报告包 API 的创建，为即将弃用 1.4 API 做准备。 | | 2025 年 10 月 25 日 |

## Adobe Analytics 中的修复

**Activity Map**：**Analysis Workspace**：AN-399209、AN-397146、AN-394992、AN-390795
**分类**：AN-400583、AN-399205、AN-398580、AN-398257、AN-395921、AN-394973
**数据收集**：**数据馈送和 Data Warehouse**：AN-400938、AN-399075、AN-398924、AN-398573、AN-396574、AN-393946
**隐私**：**Report Builder**：AN-401127、AN-400618、AN-392971、AN-391692
**报告**：**计划报告**：**区段比较**：**其他**：AN-396084
