...
# 当前Adobe Analytics发行说明（2025年7月版）

**上次更新日期**：2025年7月16日

这些发行说明涵盖2025年7月7日至8月15日的发行期。 Adobe Analytics 发布采用[持续交付模型](releases.md)，这样即可用一种更具可扩展性、分阶段的方法部署各项功能。因此，这些发行说明每月更新几次。请定期检查。
...
| **更新了客户属性 UI 的导航** | 现在可以直接从 Adobe Experience Cloud 中的应用程序选择器访问客户属性用户界面。 | 2025年7月1日 | 待定 |
