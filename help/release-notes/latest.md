...
| ----------- | ---------- | ------- | ---- |
| **新Report Builder中的安全目标支持** | 新的导出目标已添加到Report Builder加载项。 支持以下云存储目标： <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> 出于安全考虑，不再支持FTP。 （文档链接见下文） |  | 18,2025 年 6 月 |
