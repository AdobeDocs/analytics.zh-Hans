...
# 当前的 Adobe Analytics 发行说明（2025 年 5 月版本）

**上次更新日期**：2025 年 5 月 14 日

这些发行说明涵盖 2025 年 4 月 xx 日至 6 月 18 日的发行期。Adobe Analytics 发布采用[持续交付模型](releases.md)，这样即可用一种更具可扩展性、分阶段的方法部署各项功能。因此，这些发行说明每月更新几次。请定期检查。
