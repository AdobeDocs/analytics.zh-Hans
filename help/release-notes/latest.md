...
| 注意事项 | 添加或更新日期 | 描述 |
| ----------- | ---------- | ---------- |
| **系统生成电子邮件的新域** | 2022 年 7 月 13 日 | 开 **2022年5月18日**，则Adobe会从工作区项目、警报和超量警报中更改发件人的域名，该域名来自 `noreply@omniture.com` to `noreply@adobe.com`. 如果您的组织仅允许特定发件人，请将此新电子邮件添加到允许列表。 |
