...
| ----------- | ---------- | ------- |
| Workspace 中的组合图表可视化 | 通过组合图表，可在 Workspace 中更轻松且更直观地比较各种指标。[了解详情](/help/analyze/analysis-workspace/visualizations/combo-charts.md) | 已从 2022 年 9 月 14 日开始分阶段推出 |
...
| **在移动记分卡中共享批注** | 您可以在移动记分卡中显示在工作区中创建的批注。这允许您直接在移动记分卡项目中共享有关您的组织和活动的上下文数据细微差别和见解，可在 Analytics 功能板移动应用程序中查看。[了解详情](/help/analyze/analysis-workspace/components/annotations/mobile-annotations.md) | 2022 年 6 月 15 日 |
...
| 功能 | 描述 | [预定日期](releases.md) |
| ----------- | ---------- | ------- |
| 工作区批注 | 工作区批注使您能够有效地将上下文数据的细微差别和见解传达给您的组织。[了解详情](/help/analyze/analysis-workspace/components/annotations/overview.md) | 将于 2022 年 3 月 23 日开始逐步推出。正式发布：2022 年 4 月 11 日 |
