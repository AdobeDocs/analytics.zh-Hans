...
| 此发布策略是否会影响我对功能的访问？ | 不会。一旦某个功能达到 GA 阶段，您将有权访问该功能，前提是它包含在您的 Analytics 程序包中。<br>您可以在[功能访问级别](/help/admin/admin/get-started/company/feature-access-levels.md)下查看您的 Analytics 程序包的详细信息。 |
