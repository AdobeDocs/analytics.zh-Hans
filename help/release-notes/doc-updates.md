...
| --- | --- |
| **2025 年 11 月** | |
| 有关VISTA规则的重要注意事项 | 更新了有关[Vista规则](/help/technotes/vista.md)的重要注意事项。 |
| 为对话人工智能工具添加了数据列ID | 在ref_type列中添加了对话AI工具的[数据列引用ID](/help/export/analytics-data-feed/c-df-contents/datafeeds-reference.md)。 |
| **2025 年 10 月** | |
