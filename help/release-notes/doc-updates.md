...
| --- | --- |
| **2025 年 8 月** | |
| 弃用警告 | 向[分类规则生成器](/help/components/classifications/crb/classification-rule-builder.md)和[分类导入器](/help/components/classifications/importer/c-working-with-saint.md)部分中的文章添加了弃用警告。 |
| **2025 年 7 月** | |
