...
| --- | --- |
| **2023 年 8 月** | |
| 移动了关于管理计划项目的内容 | 在《Analytics组件指南》中新增了一篇文章，名为 [计划项目](/help/components/scheduled-projects-manager.md). 此内容先前位于 [计划项目](/help/analyze/analysis-workspace/curate-share/t-schedule-report.md) Analytics工具指南中的文章。 |
