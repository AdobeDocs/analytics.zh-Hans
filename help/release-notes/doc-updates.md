...
| --- | --- |
| **2023 年 11 月** | |
| Activity Map激活/启用主题的更新 | 已添加 [Web SDK](https://experienceleague.adobe.com/docs/analytics/analyze/activity-map/getting-started/activitymap-enable.html?lang=en) (手动和通过Adobe Experience Platform标记扩展)内容。 |
| **2023 年 10 月** | |
