...
| --- | --- |
| **2022 年 9 月** |  |
| 处理顺序 | 已汇总各种帮助页面，以提供有关 [处理顺序](/help/technotes/processing-order.md). |
| **2022 年 6 月** |  |
...
| **2022 年 5 月** |  |
| 通过 Experience Edge 填充生命周期维度和量度 | 现在，通过Experience Edge发送的移动设备生命周期数据会显示在Analytics报表中。 请参阅 [Analytics变量映射](/help/implement/aep-edge/variable-mapping.md) 有关XDM字段映射到现有移动设备生命周期报表的详细信息。 |
| **2022 年 4 月** |  |
