...
* 更新了文档以更好地说明[数据馈送实施](https://experienceleague.adobe.com/docs/analytics/export/analytics-data-feed/create-feed.html?lang=zh-Hans)，请参阅[此处](https://experienceleague.adobe.com/zh-hans/docs/analytics/export/analytics-data-feed/df-faq.html?lang=zh-Hans#BucketOwnerFullControl)。(AN-219485)
...
| 即将推出的 Analytics 菜单更改的通知 | 2021 年 3 月 24 日 | 2021年4月22日，Adobe更新了 **[!UICONTROL 组件]**， **[!UICONTROL 工具]**、和 **[!UICONTROL 管理员]** 下拉菜单，以实现一定程度的性能提升。 所有这些页面仍可在 **[!UICONTROL 所有组件]**， **[!UICONTROL 所有工具]**、和 **[!UICONTROL 所有管理员]** 链接 — 将从下拉菜单中删除它们。 以下是将从下拉菜单中删除并放在其相应链接页面上的菜单项：<br><br> [!UICONTROL 组件]<ul><li>[!UICONTROL 书签]</li><li>[!UICONTROL 功能板]</li><li>[!UICONTROL 目标]</li><li>[!UICONTROL 日历活动]</li><li>[!UICONTROL 计划报告]</li><li>[!UICONTROL 报告设置]</li></ul>[!UICONTROL 工具]<ul><li>[!UICONTROL Recommendations Classic]</li><li>[!UICONTROL Search &amp; Promote]</li></ul>[!UICONTROL 管理员]<ul><li>[!UICONTROL 用户管理]</li><li>[!UICONTROL 分类导入器]</li><li>[!UICONTROL 分类规则生成器]</li><li>[!UICONTROL 数据源]</li><li>[!UICONTROL Data Connectors]</li><li>[!UICONTROL 公司设置]</li><li>[!UICONTROL 日志]</li><li>[!UICONTROL Dynamic Tag Management]</li><li>[!UICONTROL 代码管理器]</li><li>[!UICONTROL 通过 IP 排除]</li><li>[!UICONTROL 流量管理]</li></ul> |
...
| 即将推出的 Analytics 菜单更改的通知 | 2021 年 3 月 24 日 | 2021年4月22日，我们将更新 **[!UICONTROL 组件]**， **[!UICONTROL 工具]**、和 **[!UICONTROL 管理员]** 下拉菜单，以实现一定程度的性能提升。 所有这些页面仍可在 **[!UICONTROL 所有组件]**， **[!UICONTROL 所有工具]**、和 **[!UICONTROL 所有管理员]** 链接 — 将从下拉菜单中删除它们。 以下是将从下拉菜单中删除并放在其相应链接页面上的菜单项：<br><br> [!UICONTROL 组件]<ul><li>[!UICONTROL 书签]</li><li>[!UICONTROL 功能板]</li><li>[!UICONTROL 目标]</li><li>[!UICONTROL 日历活动]</li><li>[!UICONTROL 计划报告]</li><li>[!UICONTROL 报告设置]</li></ul>[!UICONTROL 工具]<ul><li>[!UICONTROL Recommendations Classic]</li><li>[!UICONTROL Search &amp; Promote]</li></ul>[!UICONTROL 管理员]<ul><li>[!UICONTROL 用户管理]</li><li>[!UICONTROL 分类导入器]</li><li>[!UICONTROL 分类规则生成器]</li><li>[!UICONTROL 数据源]</li><li>[!UICONTROL Data Connectors]</li><li>[!UICONTROL 公司设置]</li><li>[!UICONTROL 日志]</li><li>[!UICONTROL Dynamic Tag Management]</li><li>[!UICONTROL 代码管理器]</li><li>[!UICONTROL 通过 IP 排除]</li><li>[!UICONTROL 流量管理]</li></ul> |
