...
| 代码管理器 | 用于管理旧版代码。授予对“管理员”>“所有管理员”>“代码管理器”的访问权限。 在大多数情况下，请改用 Adobe Experience Platform Launch 中包含的库。 |
| 代码管理器 - Web 服务 | 授予通过 1.4 API 访问代码管理器的权限。 |
| 日志 | 授予对“管理员”>“所有管理员”>“日志”的访问权限。 |
| 日志 - Web 服务 | 授予通过 1.4 API 提取日志的权限。 |
| 流量管理 | 授予对“管理员”>“所有管理员”>“流量管理”的访问权限。 |
| 权限管理 | 已不再使用。授予对“管理员”>“所有管理员”>“用户管理”下旧版用户管理界面的访问权限。 |
...
| 安全性 | 授予对“管理员”>“所有管理员”>“公司设置”>“安全管理器”的访问权限。 |
| 支持 | 授予对“管理员”>“所有管理员”>“公司设置”>“支持信息”的访问权限。 |
| Web 服务 | 授予对“管理员”>“所有管理员”>“公司设置”>“Web服务”的访问权限。 |
| 单点登录 | 已不再使用。授予对已弃用的单点登录服务的访问权限。 |
| 待定操作 | 授予对“管理员”>“所有管理员”>“公司设置”>“待定操作”的访问权限。 |
| 品牌联合 | 已不再使用。授予对“管理员”>“所有管理员”>“公司设置”>“联合品牌”的访问权限。 |
| 首选项 | 未使用。 |
| 隐藏报表包 | 授予对“管理员”>“所有管理员”>“公司设置”>“隐藏报表包”的访问权限。 允许隐藏组织内的任何报表包，而不考虑是否具有报表包的访问权限。 |
| Excel 授权用户 | 未使用。 |
...
| 集成（创建） | 授予对“管理员”>“所有管理员”>“数据连接器”的访问权限，并允许用户创建数据连接器。 |
| 集成（更新） | 授予对“管理员”>“所有管理员”>“数据连接器”的访问权限，并允许用户修改现有连接器配置。 |
| 集成（删除） | 授予对“管理员”>“所有管理员”>“数据连接器”的访问权限，并允许用户删除数据连接器。 |
