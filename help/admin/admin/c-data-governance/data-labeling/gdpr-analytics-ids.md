...
<table id="table_A5B834CC08C641D99E2691A2361997E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>如果您仅使用 Cookie ID 或那些具有 ID-DEVICE 标签的 ID，则应当只使用 ACC-ALL 标签。 </p> <p>对于每个访问请求，您将获得一对文件，其中一个文件包含与每个匹配点击对应的行，行中提供了所有指定的 ACC-ALL 字段，另一个文件则包含该数据的摘要。 </p> </td> 
  </tr> 
  <tr> 
