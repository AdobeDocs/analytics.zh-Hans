...
| [!UICONTROL 应用程序] | 支持的应用程序 [!UICONTROL 报表活动管理器] 为： <ul><li>Analysis Workspace UI</li><li>工作区计划项目</li><li>Report Builder</li><li>生成器UI:区段、计算量度、批注、受众等</li><li>来自1.4或2.0 API的API调用</li><li>智能警报</li></ul> |
