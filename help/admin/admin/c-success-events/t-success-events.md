...
1. 启用或禁用[参与率量度](/help/components/c-variables/c-metrics/metrics-participation.md)。
   ...
   >[!NOTE]
   >
   >您最多可以为 100 个自定义事件启用参与率。除此之外，您还可以在[计算量度](https://docs.adobe.com/content/help/zh-Hans/analytics/components/calculated-metrics/calcmetric-workflow/participation-metric.html)生成器中创建参与率量度。
