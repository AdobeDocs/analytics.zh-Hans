...
seo-title: 管理工具
title: 管理工具
uuid: 6961e956-14ea-4367-bdd-eb0 bcc456 aae
...
>[!IMPORTANT]
>
>请勿在同一浏览器中打开多个管理员选项卡。这可能导致您无意中将设置保存到错误的报表包。例如，如果您需要比较规则集并将它们复制到新的报表包，我们建议您打开一个新的浏览器或抓取屏幕截图来比较规则集。

+ [帐单](billing-admin.md)
+ [机器人规则概述](bot-rules/bot-rules.md)
