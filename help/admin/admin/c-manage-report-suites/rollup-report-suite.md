...
汇总报表是多个报表包中数据的简单整合，未经去重或任何区段或数据细分。汇总无需代码实施。要使用汇总报表，请[实施子报表包](/help/admin/admin/c-manage-report-suites/c-new-report-suite/t-create-a-report-suite.md)，然后使用[!UICONTROL 管理工具][将其组合为汇总报表](/help/admin/admin/c-manage-report-suites/t-rollups.md)。
