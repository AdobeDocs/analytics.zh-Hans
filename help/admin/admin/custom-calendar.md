...
>[!CAUTION]
>
>更改日历会改变数据的处理方式（即每周和每月独特访客的定义）。当日历中周和月的定义发生更改时，历史数据不会改动。此设置还会根据日期范围影响区段。
...
| 自定义日历 | 提供三个基于每月周数的格式。每月的周数取决于年度中所选的第一天。一年有 52 周。将它们分为四个季度，则每个季度有 13 周。但是一个季度有三个月。13 不可以被 3 整除，因此要将多出的一周放入其中的某一个月中，以便使其始终保持一致。<ul><li>5/4/4 表示季度的第 1 个月拥有多出的一周。4/5/4 表示季度的第 2 个月拥有多出的一周，以此类推。在 5-4-4 日历中，将在一年的最后一个季度中添加第 53 周。</li><li>4-5-4：一月份拥有四周，二月份拥有五周，三月份拥有四周，以此类推。</li><li>4-4-5：一月份拥有四周，二月份拥有四周，三月份拥有五周，以此类推。</li><li>5-4-4：一月份拥有五周，二月份拥有四周，三月份拥有四周，以此类推。</li></ul> |

>[!NOTE]
>除Data warehouse外，所有Adobe Analytics工具(Analysis Workspace、Reports &amp; Analytics、Report Builder、Activity Map)都支持这些日历选项。 data warehouse完全支持公历。 在选择非公历时，Data warehouse将使用非公历的预期日期范围，但报表行中的日/周/月划分可能不是非公历的预期日期范围。
