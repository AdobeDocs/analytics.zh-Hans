...
使用机器人规则，您可以从报表包中删除已知蜘蛛程序和机器人程序生成的流量。删除机器人程序流量可为您网站上的用户活动提供更准确的测量。
...
我们建议每个报表包定义不超过 500 个机器人规则。用户界面允许手动定义 500 个规则。在达到此限制后，必须通过“[导入文件](../../../admin/admin/bot-rules/t-upload-bot-rules.md#task_95868D8564564E6A996163335C119806)”和“导出机器人规则”选项对规则进行批量管理。

机器人程序流量数据存储在单独的库中，以便在[!UICONTROL 机器人]和[!UICONTROL 机器人页面]报表中显示。

| 规则类型 | 描述 |
|--- |--- |
| IAB | 选择[!UICONTROL 包含 IAB] 将会使用 IAB/ABCe 国际蜘蛛程序和机器人程序列表 (IAB/ABCe International Spiders &amp; Bots List) 删除机器人程序流量。此列表由 IAB 每月更新。<br>要将机器人提交到IAB列表，请访问 [IAB](https://www.iab.net/sites/spiders/form.php)。<br>Adobe 无法向客户提供详细的 IAB 机器人程序列表，但是您可以使用“机器人报表”来查看访问您网站的机器人程序的列表。 |
| 自定义机器人规则 | 请参阅 [创建自定义机器人规则](../../../admin/admin/bot-rules/t-create-bot-rules.md). |
