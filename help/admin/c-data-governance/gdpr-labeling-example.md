...
| API 值 | API 值 | 返回文件类型 | <br>摘要访问文件中的数据 </br> | <br>摘要访问文件中的数据</br> | <br>摘要访问文件中的数据</br> | <br>摘要访问文件中的数据</br> | <br>摘要访问文件中的数据</br> |
|--- |--- |--- |---|---|---|---|---|
...
| user= maryExpands<br>= false</br> | user= maryExpands<br>= false</br> | user= maryExpands<br>= false</br> | user= maryExpands<br>= false</br> | user= maryExpands<br>= false</br> |
|--- |---|---|---|---|
| MyProp1 | AAID | MyEvar1 | MyEvar2 | MyEvar3 |
...
| user=Mary<br>expandIDs=true</br> | user= maryExpands<br>= true</br> | user= maryExpands<br>= true</br> | user= maryExpands<br>= true</br> | user= maryExpands<br>= true</br> |
|--- |---|---|---|---|
| MyProp1 | AAID | MyEvar1 | MyEvar2 | MyEvar3 |
