...
有关如何在请求中包含此选项的示例，请参阅 [JSON 请求示例](../../admin/c-data-governance/gdpr-submit-access-delete.md#section_DB9DE6492FE740918F91D413E7BAB88F)。更多详细信息，请参阅 [GDPR API 文档](https://www.adobe.io/apis/experienceplatform/gdpr.html)。
...
>[!NOTE]
>The [GDPR API](https://www.adobe.io/apis/experienceplatform/gdpr.html) has been provided to help you fulfill GDPR requests, which are time sensitive. Adobe不支持使用此API进行其他目的，并且可能会影响Adobe提供对其他Adobe客户的高优先级、用户发起的GDPR请求的及时周转。我们要求您不要使用GDPR API，例如清除在大量访客群中意外提交的数据。
>
