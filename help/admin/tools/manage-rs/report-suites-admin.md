---
description: 报表包定义针对某个所选网站、网站集合或网页子集的完整、独立的报表。
title: 报告包管理器
...
报表包定义针对以下任意数据存储的完整、独立的报表：

* 单个网站（最典型）

* 单个网站的一部分或子集

* 为获得总数而合并的若干个网站数的全局区段

Analytics解决方案对这些数据存储进行汇总和报告。 通过管理员报表包管理器，可定义用于控制如何在报表包中处理数据的规则。

在登录到任何 Adobe Analytics 解决方案时，您需要选择一个要使用的报表包（除非您使用的是合并各报表包的统计报表包）。

要访问报表包，请执行以下操作：

单击 **[!UICONTROL Analytics]** > **[!UICONTROL 管理员]** > **[!UICONTROL 所有管理员]** > **[!UICONTROL 报表包]**
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 允许您在报表包列表中查找特定的报表包。 搜索工具包括基于名称的基本搜索和高级搜索页面，用于进行深入搜索。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle">群组 </span> </td> 
   <td colname="col2"> <p>允许您将报表包组织到自定义组中。 您可以快速访问多个共享相似设置或通常一起编辑的报表包。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>汇总是指一个报表包中合并了数个其他报表包的跟踪数据。 </p> <p>请参阅<a href="/help/admin/tools/manage-rs/rollup-report-suite.md">汇总报表包</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2">请参阅<a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新的报表包</a>。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在“管理工具”和市场营销报告标题的报表包下拉列表中标识报表包。 </p> <p>请参阅<a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新的报表包</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> 基本 URL</span> </td> 
   <td colname="col2"> <p>定义报表包的基本域。 </p> <p>请参阅<a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新的报表包</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
