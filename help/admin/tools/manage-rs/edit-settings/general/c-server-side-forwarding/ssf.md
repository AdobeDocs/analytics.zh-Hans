---
description: 服务器端转发适用于希望实时将数据从Analytics共享到其他CX Enterprise解决方案的客户。 启用服务器端转发后，Analytics还可以在数据收集过程中将数据推送到其他CX Enterprise解决方案，并让这些解决方案将数据推送到Analytics。
solution: Analytics
title: 服务器端转发概述
...
服务器端转发适用于希望实时将数据从Analytics共享到其他CX Enterprise解决方案的客户。 启用服务器端转发后，Analytics还可以在数据收集过程中将数据推送到其他CX Enterprise解决方案，并让这些解决方案将数据推送到Analytics。
...
* 让您能够利用CX Enterprise解决方案之间的数据共享。
