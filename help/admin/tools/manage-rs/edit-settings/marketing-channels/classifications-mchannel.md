---
title: 营销渠道中的分类
description: 使用分类可将值分类为相关的组，并在组级别报告。 例如，您可以将所有“付费搜索”营销活动归为一个类似视频卡的类别。 然后，可在该类别相对于“实例”（或“点进次数”）等量度而成功时进行报告。
...
使用分类可将值分类为相关的组，并在组级别报告。 例如，您可以将所有“付费搜索”营销活动归为一个类似视频卡的类别。 然后，可在该类别相对于“实例”（或“点进次数”）等量度而成功时进行报告。
