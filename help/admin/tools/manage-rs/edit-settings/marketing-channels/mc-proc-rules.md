...
| **[!UICONTROL 引用网站与内部URL筛选器匹配]** | 点击包含与[内部URL过滤器](../general/internal-url-filter-admin.md)匹配的[反向链接](/help/components/dimensions/referrer.md)。 |
...
| **[!UICONTROL 反向链接]** | [反向链接](/help/components/dimensions/referrer.md)维度。 |
...
| **[!UICONTROL 搜索关键词]** | [搜索关键词](/help/components/dimensions/search-keyword.md)维度。 |
