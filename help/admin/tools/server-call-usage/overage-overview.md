...
<table id="table_4E97F85F13344A2C962FA4FA5A51642E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>对服务器调用记帐的法人。 例如，adobe.com。 每个账单公司都有一个账单ID，用于唯一标识账单客户。 计费ID可以绑定到多个Experience Cloud组织；组织和计费ID之间并不总是存在1:1的关系。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_86256AD8B4554F369439A8FDF2F545E1"> 
 <thead> 
  <tr> 
   ...
   <th colname="col4" class="entry"> 如果您已登录到Adobe Experience Cloud，则授予权限 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
