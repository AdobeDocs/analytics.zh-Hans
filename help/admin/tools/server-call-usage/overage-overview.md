...
* **权限：**&#x200B;您必须拥有Adobe Analytics管理员访问权限或Adobe Admin Console中的[服务器调用使用情况](/help/admin/admin-console/permissions/analytics-tools.md)权限项。 管理员可以通过产品配置文件将此权限项分配给非管理员。
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>一个账单公司可以拥有<a href="https://helpx.adobe.com/cn/analytics/kb/multiple-login-companies.html">多个登录公司</a>。 登录公司是您的组织使用的报表包的集合。 某些组织具有多个适用于该组织不同部分的登录公司。 这对于处理不同业务部门的大型组织尤其有用，因为此类组织有许多报表包不适用于公司中的其他报表包。 </p> <p>通常，这些是公司的地区性子公司。 此示例显示了登录公司及其关联的报表包： </p> 
    ...
    </ul> <p>注意：一个账单公司所拥有的<u>所有</u>报表包的服务器调用使用情况数据对具有相应<a href="/help/admin/admin-console/permissions/analytics-tools.md">权限</a>的所有用户都可见。 </p> </td> 
  </tr> 
  <tr> 
