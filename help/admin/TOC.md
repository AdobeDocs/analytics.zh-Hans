...
+ Adobe Admin Console {#admin-console} {#admin-console}
   ...
   + Analytics 工具权限摘要 {#permissions} {#permissions}
...
+ Analytics 管理员工具 {#admin-tools} {#admin-tools}
   ...
   + [日志](admin/logs.md)
   + 报告活动管理器 {#reporting-activity-manager} {#reporting-activity-manager}
   ...
   + 组件迁移 {#component-migration} {#component-migration}
      + [准备迁移](admin/component-migration/prepare-component-migration.md)
      + [迁移工作流](admin/component-migration/component-migration.md)
   + 报告包管理器 {#manage-report-suites} {#manage-report-suites}
      + 编辑报告包设置 {#edit-report-suite} {#edit-report-suite}
         + 常规 {#report-suite-general} {#report-suite-general}
            ...
            + 付费搜索检测 {#paid-search-detection} {#paid-search-detection}
            ...
            + 处理规则 {#c-processing-rules} {#c-processing-rules}
               + [处理规则概述](admin/c-manage-report-suites/c-edit-report-suites/general/c-processing-rules/processing-rules.md)
               + 处理规则 {#c-processing-rules-configuration} {#c-processing-rules-configuration}
               ...
               + 处理规则示例{#processing-rules-examples} {#processing-rules-examples}
            ...
            + 服务器端转发 {#server-side-forwarding} {#server-side-forwarding}
         ...
         + 流量 {#traffic-variables} {#traffic-variables}
         ...
         + 转化 {#conversion-variables} {#conversion-variables}
            ...
            + 独特访客变量 {#unique-visitor-variable} {#unique-visitor-variable}
         ...
         + 营销渠道 {#marketing-channels} {#marketing-channels}
         ...
         + 应用程序管理 {#app-management} {#app-management}
         ...
         + 实时 {#real-time-reports} {#real-time-reports}
      ...
      + 新的报告包 {#c-new-report-suite} {#c-new-report-suite}
      ...
      + 报告包模板 {#report-suite-templates} {#report-suite-templates}
   ...
   + 公司设置 {#company-settings} {#company-settings}
   ...
   + 服务器调用使用情况 {#server-call-usage} {#server-call-usage}
   ...
   + 用户和产品管理（旧版）{#user-product-management} {#user-product-management}
      + [用户和产品管理（旧版）](admin/user-management2/user-management.md)
      + [管理旧版用户帐户、资源和有效期限](admin/user-management2/users-assets.md)
      + 将用户迁移到 Adobe Admin Console {#migrate-users} {#migrate-users}
