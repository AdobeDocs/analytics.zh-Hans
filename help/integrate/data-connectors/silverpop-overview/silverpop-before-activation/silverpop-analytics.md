...
* **可用和配置的Analytics变量：** 此集成需要个自定义事件和个自定义eVar，还需要个额外事件和其他eVar。See [Analytics Integration Variables](../../silverpop-overview/silverpop-variables.md#concept-6c8a359719fd4794a42f5f6fb118f8b2).
