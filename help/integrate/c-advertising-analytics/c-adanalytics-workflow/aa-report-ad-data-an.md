...
> [!NOTE] 您应该至少等待24小时，然后搜索引擎数据开始填充到您的Analytics报告中。 另请注意，Analytics 报表不会以每小时的时间粒度返回数据，因为 AMO 数据不支持每小时的时间粒度。
...
> [!NOTE] 即使您尚未实施任何广告帐户，所有客户都可以看到“广告模板”类别。 但是，如果您尝试为尚未配置该帐户的公司打开搜索引擎模板，则会显示一条错误消息，提示您尚未配置任何搜索引擎帐户。在这种情况下，请单击&#x200B;**[!UICONTROL 立即配置]**，然后便可看到[广告帐户设置](../../../integrate/c-advertising-analytics/c-adanalytics-workflow/aa-create-ad-account.md#concept_1958E8C15C334E8B9DC510EC8D5DCA7C)页面。
...
| 广告平台 | 有关前2个平台(Google、Bing)的成本的圆环图。 |
