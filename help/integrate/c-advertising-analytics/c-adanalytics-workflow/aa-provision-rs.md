---
description: 配置要在Advertising Analytics中使用的CX Enterprise映射报表包。
...
要在Analytics中查看任何Advertising Analytics搜索数据，您需要为Advertising Analytics报表配置每个CX Enterprise映射的报表包。

1. 导航至&#x200B;**[!UICONTROL 管理员]** > **[!UICONTROL 报表包]**。

1. 选择映射到您的CX Enterprise组织的报表包。
