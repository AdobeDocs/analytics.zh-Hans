...
有时候，可用性问题也会影响登录。 有关任何维护事件，请查看 [status.adobe.com](https://status.adobe.com/zh-cn)。 否则，请根据组织的身份验证方法使用相应的部分。
...
>[!IMPORTANT]
>
>以下重置用户密码的步骤仅适用于旧版Analytics ID，而不适用于Adobe ID。 如果您的组织使用Adobe ID，则可以在[adminconsole.adobe.com](https://adminconsole.adobe.com)管理用户帐户。
