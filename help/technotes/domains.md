---
title: Adobe Analytics使用的域
description: 允许这些域通过贵组织的防火墙，以获得最佳的Adobe Analytics使用体验。
...
某些防火墙配置会阻止Adobe Analytics作为其产品界面所依赖的域。 您可以使用此域列表来更改组织的网络设置，以允许从组织内部访问产品。 Adobe建议允许这些域通过贵组织的防火墙以获得最佳体验。
