...
2023年3月2日，已将客户端提示纳入Analytics设备查找过程。 此更改同时适用于AppMeasurement和Web SDK实施。
...
+++**为什么我看到的浏览器版本号是999.99？**

客户有时使用无效的浏览器或设备操作系统版本号执行测试，这些版本号可以是超过100,000的任何数字。 为了避免在给定日期出现大量无效的浏览器或设备操作系统版本号，任何超过100,000的版本号将存储在一起并固定到版本号999.99。
