...
从2023年3月开始，客户端提示将纳入Analytics设备查找过程。 AppMeasurement 和 Web SDK 目前都支持收集提示数据，但直到 2 月中旬才会用于设备查找。如下所述，操作系统版本已从 10 月开始冻结，但由于逐步推出以及许多用户代理已提高冻结的操作系统版本（有关更多信息，请参见[此处](https://experienceleague.adobe.com/docs/analytics/components/dimensions/operating-systems.html?lang=zh-Hans)），我们估计这将影响不到 3% 的 Chrome 访客。
