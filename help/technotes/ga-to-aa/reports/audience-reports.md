...
请参阅 [国家/地区](/help/components/dimensions/countries.md) 组件用户指南中的维度以了解更多信息。
...
* [监视器分辨率](/help/components/dimensions/monitor-resolution.md)
...
请参阅 [移动设备类型](/help/components/dimensions/mobile-dimensions.md) 维度。
...
请参阅 [移动设备](/help/components/dimensions/mobile-dimensions.md) 维度。
