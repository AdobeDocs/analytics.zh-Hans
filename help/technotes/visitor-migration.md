...
<table id="table_7B2535FC3E264216A299686415C6B21C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>进行此更改后，请使用 [数据包监视器](../implement/validate/packet-monitor.md) 来验证 Analtyics 图像请求是否被发送到更新后的数据收集服务器。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>更新 Analytics 代码之后立即执行</b>：测试网站，验证是否会重定向到之前的数据收集域。 </p> </td> 
   <td colname="col3"> <p>使用[数据包监视器](../implement/validate/packet-monitor.md) 来验证当您第一次访问自己的网站时，或者在清除了 Cookie 后，是否在 200（正常）HTTP 状态代码之前，看到两个 302（重定向）HTTP 状态代码。如果这些重定向中有任何一个出现失败，请立即联系客户关怀，确保迁移配置正确。 </p> </td> 
  </tr> 
  <tr> 
