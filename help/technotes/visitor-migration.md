...
* 从 `2o7.net` 转移到 `omtrdc.net`（[区域数据收集](https://marketing.adobe.com/resources/help/en_US/whitepapers/rdc/)）。

* 您将要实施 [Experience Cloud 访客 ID 服务](https://marketing.adobe.com/resources/help/en_US/mcvid/)并从 CNAME/第一方数据收集域转移到 `2o7.net` 或 `omtrdc.net`（[区域数据收集](https://marketing.adobe.com/resources/help/en_US/whitepapers/rdc/)）。
...
<table id="table_7B2535FC3E264216A299686415C6B21C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>进行此更改后，请使用[数据包监视器](../implement/validate/packet-monitor.md)验证Analtyics图像请求是否将转到更新的数据收集服务器。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>更新 Analytics 代码之后立即执行</b>：测试网站，验证是否会重定向到之前的数据收集域。 </p> </td> 
   <td colname="col3"> <p>使用 [数据包监视器](../implement/validate/packet-monitor.md)，以验证您首次访问站点时或清除Cookie后，在200（确定）HTTP状态代码之前可以看到两个302（重定向）HTTP状态代码。 如果这些重定向中有任何一个出现失败，请立即联系客户关怀，确保迁移配置正确。 </p> </td> 
  </tr> 
  <tr> 
