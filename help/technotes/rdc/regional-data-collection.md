...
>[!IMPORTANT]
>
>中国 RDC（中国性能优化）加载项包是 Adobe Analytics 的收费加载项。Adobe 在中国大陆推出的性能优化使在中国境内拥有用户的客户能够将数据直接发送到中国境内的 Adobe Edge Collection 服务器，而不用发送到全球其他位置。与将数据发送到中国境外的节点相比，这样做可缩短页面加载时间并提高数据准确性。请注意，数据最终会传输到中国境外的 Adobe 数据处理中心 (DPC) 之一。有关更多信息，请与您的 Adobe 销售代表联系。
